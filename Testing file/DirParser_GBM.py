...
featuresOutFn = 'GBM_features_GLCM_test_X_Y_ym4xm4_yp4xp4_6.csv'
...
def Mean_Std_LargestBox2(dicomimage,largeX,largeY,largeX2,largeY2):
    ...
    print maxg, ming,len(LargeBoxGrayLevel)
            ...
            for slicelist in ptslice:
                ...
                for GLCMAngle in GLCMAngleList:
                    for eachdcm in dicomnames:
                        ...
                        #subImage2 = GrayScaleNormalization(subImage, maxgraylevel-mingraylevel,mingraylevel)
                        imgrange = subImage.max() - subImage.min()

                        print subImage
                        print 'my:',maxgraylevel-mingraylevel
                        print 'Ross',imgrange

                        imgMin = subImage.min()
                        subImage = GrayScaleNormalization(subImage,imgrange, imgMin)
