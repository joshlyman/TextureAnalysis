# Plot CEDM 92 images with ROI and largest box
...
Outputimage = '/Users/yanzhexu/Desktop/Research/CEDM_ROI_QualityControl/LargestBoxImageCheck_92/'
    ...
    for casefile in os.listdir(rootDir):
        ...
        for folder2 in os.listdir(lesionpath):
            ...
            for phase in phasenames:
                ...
                outputDir = Outputimage + casename + ' '+phase + imagefile


                figureDir = os.path.join(outputDir)

                plt.title(casename + ' '+ phase + ' LargestBox')
