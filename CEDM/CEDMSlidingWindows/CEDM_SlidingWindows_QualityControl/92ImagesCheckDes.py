# This is to check if DES can be plotted successfully
#
...
Outputimage = '/Users/yanzhexu/Desktop/Research/CEDM_ROI_QualityControl/92ImagesCheckDes/'
    ...
    for casefile in os.listdir(rootDir):
        ...
        for folder2 in os.listdir(lesionpath):
            ...
            for lesionfile in os.listdir(lesionpath2):
                ...
                if fnmatch.fnmatch(lesionfile,'*CC*DES*'):
                    phasefile['DES-CC'] = lesionfile

                if fnmatch.fnmatch(lesionfile,'*MLO*DES*'):
                    phasefile['DES-MLO'] = lesionfile

                if fnmatch.fnmatch(lesionfile, '*CC*xml'):
                    roixmlfile['DES-CC'] = lesionfile

                if fnmatch.fnmatch(lesionfile, '*MLO*xml'):
                    roixmlfile['DES-MLO'] = lesionfile
