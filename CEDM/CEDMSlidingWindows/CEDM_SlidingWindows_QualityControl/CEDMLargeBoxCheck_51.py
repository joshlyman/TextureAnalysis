# Plot CEDM 51 images with ROI and largest box
...
Outputimage = '/Users/yanzhexu/Desktop/Research/CEDM_ROI_QualityControl/LargestBoxImageCheck_51/'
    ...
    for twofolder in os.listdir(rootDir):
        ...
        for casefile in os.listdir(rootDir2):
            ...
            for phase in phasenames:
                ...
                CSVDir = os.path.join(lesionpath,largeboxfile)
                ...
                imagefile = ' LargestBox.png'
                outputDir = Outputimage + casefile + ' '+phase + imagefile


                figureDir = os.path.join(outputDir)

                plt.title(casefile + ' '+ phase + ' LargestBox')
                plt.savefig(figureDir,bbox_inches='tight')
                plt.cla()
                plt.close()
