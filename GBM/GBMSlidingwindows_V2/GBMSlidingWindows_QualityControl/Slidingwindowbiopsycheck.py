...
outputDir = '/Users/yanzhexu/Desktop/Research/Sliding box GBM/MyAlgorithmPlot/Slidingwindowbiopsycheck/'
...
def ParseXMLDrawROI(rootDir):
    ...
    drawSameRangeScalePlot(xmin-20, xmax+20, ymin-20, ymax+20, 8, 'k')
...
def checkallXML(rootDir):
    ...
    for texturemapfile in os.listdir(rootDir):
        ...
        for slicefile in os.listdir(slicepathfile):
            ...
            # original image T1
            plt.figure()
            xmin,xmax,ymin,ymax = ParseXMLDrawROI(T1xmlfilepath)
            ...
            # original image T2
            plt.figure()
            xmin, xmax, ymin, ymax = ParseXMLDrawROI(T2xmlfilepath)
            drawbiopsy(biopsycoordinatefile, newpatientname, slicenum, xmin, xmax, ymin, ymax)
