...
outputfolder = '/Users/yanzhexu/Desktop/Research/Sliding box GBM/ColorMap/ColorMap_T1_PI_WO_Necros_Andrea_0322_basedon_T1_by040618/'
...
def generate6Predictplot(dcmDir):
    ...
    for texturemapfile in os.listdir(dcmDir):
        ...
        for slicefile in os.listdir(slicepathfile):
            ...
            plt.title(newpatientname +' '+ ' '+ slicefile + ' T1 PI W/O Necrosis',fontsize = 30)

            plt.savefig(outputfolder + newpatientname +' '+ ' '+ slicefile + ' T1 PI WO Necrosis based on T1.png')
            plt.cla()
            plt.close()
