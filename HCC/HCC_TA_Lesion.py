...
#=========================================================================
#
# Extract texture features from a region-of-interest within a HCC lesion dicom image
# (lesion dicom normalized by itself)
#
#=========================================================================
...
# 3. fix Gabor features input, put newest features in folder
#
...
featuresOutFn = 'HCC_features_Lesion_LBP_3_2.csv'
