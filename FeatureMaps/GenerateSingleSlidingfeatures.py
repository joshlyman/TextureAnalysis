...
def chooseinoutcoord(contourx1,contourx2,contoury1,contoury2,xycoord):
    ...
    for testx in range(contourx1,contourx2+1,4):
        for testy in range(contoury1,contoury2+1,4):
...
# Image Root Dir
rootDir = '/Users/yanzhexu/Google Drive/Marley Grant Data/CEDM-51'

outputDir = '/Users/yanzhexu/Desktop/Research/featureMap'
...
def genFeatures():
    ...
    featureTitle = ['PatientID', 'Dicom Image Filename', 'Xml Filename', 'Phase Name', 'X', 'Y']
        ...
        for phase in phasenames:
            ...
            if fnmatch.fnmatch(phase,'*CC'):
                ...
                for eachpt in CCwindowptlist:
                    ...
                    aFeature = [patientID, lesionDicomFn, roiccxml, phase, xcoord, ycoord]
                ...
                for eachpt in MLOwindowptlist:
                    ...
                    aFeature = [patientID, lesionDicomFn, roimloxml, phase, xcoord, ycoord]
