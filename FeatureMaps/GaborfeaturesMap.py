...
featurefile = '/Users/yanzhexu/Desktop/Research/Sliding box CEDM/addYlabel/CEDM_TextureMap_51/Pt19_malignant_ROI_Texture_Map.csv'
...
dcmfile = '/Users/yanzhexu/Google Drive/Marley Grant Data/CEDM-51/malignant/Pt19/Pt19 - LE - CC.dcm'

xmlfile = '/Users/yanzhexu/Google Drive/Marley Grant Data/CEDM-51/malignant/Pt19/FP-RCC.xml'
...
with open(featurefile,'r') as readfile:
    ...
    for row in rowFile:
        ...
        # if row[0] =='EPI':
            ...
            sldx = int(row[4])
            sldy = int(row[5])
            entropy = float(row[30]) # gabor mean starts from 30
...
#
# plt.show()
imgpath = '/Users/yanzhexu/Desktop/Research/featureMap/'
title = 'Pt19 LE CC Gabor Mean Feature Map'
plt.title(title)
