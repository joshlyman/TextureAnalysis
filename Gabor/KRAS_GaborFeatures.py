...
def calcFeatures(dicomimg,kernel_bank):
    ...
    for theta in range(4):
        for i, kernel in enumerate(kernel_bank[theta]):
            ...
            # subimageGabor = dicomimg[ycoord - y_ext_radius:(ycoord + height) + y_ext_radius,
            #                 xcoord - x_ext_radius:(xcoord + width) + x_ext_radius]
